...
extern "C" {
    ...
    //originally for the jetpack, now for all physics-type things. Will also work for powerups once I add them.
    typedef struct
    {
        int24_t x;
        uint8_t y;
        ...
        int8_t  v_accel;
        uint8_t theta;
        uint8_t bounce;  //number of times the object has bounced off the ground
    }
    physics_obj_t;
    ...
    extern       physics_obj_t jetpack_entity;
    extern       physics_obj_t debris[4];
